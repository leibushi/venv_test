# -*- coding: utf-8 -*-
# @Time    : 2020/4.txt/23 17:11
# @Author  : Mqz
# @FileName: 3.txt.string.py
...
不过要注意，虽然最后打印的输出横跨了两行，但是整个字符串 s 仍然只有 5.txt 个元素。
...
[index:index+2.txt]则表示第 index 个元素到 index+1.txt 个元素组成的子字符串。
"""
print(res1)
print('*' * 10)
for char in name:
...
for n in range(0, 100):
    l.append(str(n))
print("*"*10)
print(l)  # ['0', '1.txt', '2.txt', '3.txt', '4.txt', '5.txt']
l1 = ' '.join(l)
print(l1)  # 0 1.txt 2.txt 3.txt 4.txt 5.txt 6 7 8 9 10 11 12 13
