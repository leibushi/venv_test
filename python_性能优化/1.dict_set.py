# -*- coding: utf-8 -*-
# @Time    : 2020/4/10 11:40
# @Author  : Mqz
# @FileName: 1.dict_set.py

"""
python性能优化
上述代码运行大概需要 2.010 seconds。如果去掉行 #list = dict.fromkeys(list,True) 的注释，
将 list 转换为 dict 之后再运行，时间大约为 1.015 seconds，效率大概提高了一半。
